...
<head>
    ...
    <meta name="description" content="Sistema de Gestión Veterinaria — Panel Administrador">
    <meta name="author" content="">

    <title>@yield('titulo_pagina', 'Administrador') - Sistema Veterinaria</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                {{-- ===== TOPBAR ADMIN ===== --}}
                @include('layouts.admin_partials.topbar')
                {{-- ===== FIN TOPBAR ADMIN ===== --}}
    ...
    @include('layouts.admin_partials.logout_modal')
    {{-- ===== FIN MODAL ===== --}}
